        ...
        while (true) {
            ...
            switch (command) {
                ...
                case "2" -> {
                    ...
                    Block newBlock = newBlock(this.chain.getLastBlock.index+1, this.chain.getPreviousHash(), this.chain.getTransactions());
                ...
                case "5" -> {
                    ...
                    Block minedBlock = newBlock(this.chain.getLastBlock.index+1, this.chain.getPreviousHash(), this.chain.getTransactions());
