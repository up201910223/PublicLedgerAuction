        ...
        while (true) {
            ...
            switch (command) {
                ...
                case "2" -> {
                    ...
                    Block newBlock = newBlock(chain.getLastBlock.index+1, chain.getPreviousHash(), chain.getTransactions());
                ...
                case "5" -> {
                    ...
                    Block minedBlock = newBlock(chain.getLastBlock.index+1, chain.getPreviousHash(), chain.getTransactions());
